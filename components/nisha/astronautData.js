...
function createNewUser(name, password, email) {
    ...
    sendEmail(email);
    // document.writeln("<h1>Email sent successfully!</h1>");
    document.write('<h1 style="text-align: center;">Thank you!</h1>');
    document.write('<h3 style="text-align: center;">You have successfully signed up.</h3>');
    user.storeInfo();
}
